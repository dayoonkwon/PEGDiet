...
### Final figure
```{r,message=FALSE}
png("hei.png", width = 450, height = 630, units='mm', res = 400)
ggarrange(ggarrange(hei_beta,hei_alpha, nrow=1,labels = c("a", "b"), 
                    widths = c(2.2,1.7),font.label=list(color="black",size=25)),
          ggarrange(hei_phylum,hei_genus, nrow=1,labels = c("c", "d"), 
                    widths = c(2.3, 2.8),font.label=list(color="black",size=25)),
          ggarrange(hei_taxa, nrow=1,labels="e", 
                    widths = 3,font.label=list(color="black",size=25)),
          nrow=3, heights = c(0.6,1.3,1))
dev.off()

png("fiber.png", width = 450, height = 630, units='mm', res = 400)
ggarrange(ggarrange(fiber_beta,fiber_alpha, nrow=1,labels = c("a", "b"), 
                    widths = c(2.2,1.7),font.label=list(color="black",size=25)),
          ggarrange(fiber_phylum,fiber_genus, nrow=1,labels = c("c", "d"), 
                    widths = c(2.3, 2.8),font.label=list(color="black",size=25)),
          ggarrange(fiber_taxa,nrow=1,labels="e",
                    widths = 3,font.label=list(color="black",size=25)),
          nrow=3, heights = c(0.6,1.3,1))
dev.off()

png("sugar.png", width = 450, height = 630, units='mm', res = 400)
ggarrange(ggarrange(sugar_beta,sugar_alpha, nrow=1,labels = c("a", "b"), 
                    widths = c(2.2,1.7),heights = 0.6,font.label=list(color="black",size=25)),
          ggarrange(sugar_phylum,sugar_genus, nrow=1,labels = c("c", "d"), 
                    widths = c(2.3, 2.8),heights = 1,font.label=list(color="black",size=25)),
          ggarrange(sugar_taxa,nrow=1,labels="e",
                    widths = 3,heights = 0.9,font.label=list(color="black",size=25)),
          nrow=3, heights = c(0.6,1.3,1))
dev.off()
```